...
SQL;
     ...
     *
     * {@inheritDoc}
     * @see \exface\Core\Interfaces\CmsConnectorInterface::setServiceWorker()
     */
    public function setServiceWorker(string $jsCode, string $imports = '') : string
    {
        $code = <<<JS
/**
 * This file is generated by the CMS Connector! Changes will be overwritten automatically!
 * 
...
JS;
        ...
        $path = $this->getPathToModxFolder() . DIRECTORY_SEPARATOR . $filename;
     ...
     *
     * {@inheritDoc}
     * @see \exface\Core\Interfaces\CmsConnectorInterface::buildUrlToServiceWorker()
     */
    public function buildUrlToServiceWorker() : string
    {
        return $this->getApp()->getConfig()->getOption("INSTALLER.SERVICEWORKER.URL");
    }
}
?>